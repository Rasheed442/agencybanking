        ...
        <div className={style.bg}>
          ...
          <div className={style.walletbalance}>
            <div className={style.wallet}>
              ...
              <h5>
                <MdShowChart />
                5.5%<span> up from last week</span>
              </h5>
            </div>
            ...
            <div className={style.wallet}>
              ...
              <h5 style={{ color: "red" }}>
                <MdShowChart />
                2.1%<span> up from last week</span>
              </h5>
            </div>
          ...
          <div className={style.service}>
            <div className={style.services}>
              ...
              <select>
                <option>
                  Most Used Services <AiOutlineDown />
                </option>
                <option>
                  Alphabetically <AiOutlineDown />
                </option>
                <option>
                  Latest Service <AiOutlineDown />
                </option>
                <option>
                  Rarely Used Service <AiOutlineDown />
                </option>
              </select>
            </div>
          ...
          <div className={style.footer}>
            ...
            <div className={style.btn}>
              <button
                style={{ border: "1px solid gainsboro", color: "#969494" }}
              >
                <AiOutlineArrowLeft />
                &nbsp;Previous
              </button>
              ...
              <button style={{ border: "1px solid #1B59F8", color: "#1B59F8" }}>
                Next&nbsp;
                <AiOutlineArrowRight />
              </button>
            </div>
