...
function Setcommission({ cancelall }) {
  ...
  async function Updateall(e) {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API}settings/transactioncap`,
      {
        method: "POST",
        headers: {
      ...
      <div className={style.white}>
        ...
        <div className={style.inputs}>
          <div className={style.billername}>
            <label>
              Daily Limit <span style={{ color: "red" }}>*</span>
            </label>
          ...
          <div className={style.billername}>
            <label>
              Daily Limit Sending<span style={{ color: "red" }}>*</span>
            </label>
            <div className={style.caret}>
              <input
                type="number"
                placeholder="18"
                onChange={(e) => setDailysending(e.target.value)}
              />
            </div>
          </div>
          ...
          <div className={style.billername}>
            <label>
              Daily Limit Receiving <span style={{ color: "red" }}>*</span>
            </label>
            <div className={style.caret}>
              <input
                type="number"
                onChange={(e) => setDailyreceiving(e.target.value)}
                placeholder="28"
              />
            </div>
          </div>
          ...
          <div className={style.billername}>
            <label>
              Weekly Limit <span style={{ color: "red" }}>*</span>
            </label>
            <div className={style.caret}>
              <input
                type="number"
          ...
          <div className={style.billername}>
            <label>
              Weekly Limit Sending <span style={{ color: "red" }}>*</span>
            </label>
            <div className={style.caret}>
              <input
                type="number"
                placeholder="1,500,000.00"
                onChange={(e) => setWeeklysending(e.target.value)}
              />
            </div>
          </div>
          ...
          <div className={style.billername}>
            <label>
              Weekly Limit Receiving<span style={{ color: "red" }}>*</span>
            </label>
            <div className={style.caret}>
              <input
                type="number"
                onChange={(e) => setWeeklyreceiving(e.target.value)}
                placeholder="1,500,000.00"
              />
            </div>
          </div>
          ...
          <div className={style.billername}>
            <label>
              Monthly Limit <span style={{ color: "red" }}>*</span>
            </label>
            <div className={style.caret}>
              <input
                type="number"
          ...
          <div className={style.billername}>
            <label>
              Monthly Limit Sending<span style={{ color: "red" }}>*</span>
            </label>
            <div className={style.caret}>
              <input
                type="number"
                onChange={(e) => setMonthlysending(e.target.value)}
                placeholder="1,500,000.00"
              />
            </div>
          </div>
          ...
          <div className={style.billername}>
            <label>
              Monthly Limit Receiving <span style={{ color: "red" }}>*</span>
            </label>
            <div className={style.caret}>
              <input
                type="number"
                onChange={(e) => setMonthlyreceiving(e.target.value)}
                placeholder="1,500,000.00"
              />
            </div>
          </div>
          <div className={style.billername}>
            <label>
              Yearly Limit <span style={{ color: "red" }}>*</span>
            </label>
            <div className={style.caret}>
              <input
                type="number"
          ...
          <div className={style.billername}>
            <label>
              Yearly Limit Sending<span style={{ color: "red" }}>*</span>
            </label>
            <div className={style.caret}>
              <input
                type="number"
                onChange={(e) => setYearlysending(e.target.value)}
                placeholder="1,500,000.00"
              />
            </div>
          </div>
          <div className={style.billername}>
            <label>
              Yearly Limit Receiving <span style={{ color: "red" }}>*</span>
            </label>
            <div className={style.caret}>
              <input
                type="number"
                onChange={(e) => setYearlyreceiving(e.target.value)}
                placeholder="1,500,000.00"
              />
            </div>
          </div>
