...
function transactionlimit() {
  ...
  const transactioncap =
    typeof window !== "undefined"
      ? localStorage.getItem("allow_set_transactioncap")
      : "";
            ...
            <div className={style.gridout}>
              <div className={style.limits}>
                ...
                <div className={style.flexout}>
                  ...
                  <div className={style.transaction}>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.daily_limit_sending}1.2%
                    </p>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.daily_limit_receiving}1.2%
                    </p>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.daily_limit} 1.2% per day
                    </p>
                  </div>
                </div>
              ...
              <div className={style.limits}>
                <div className={style.timer}>
                  ...
                  <div>
                    ...
                    <span>
                      Increase or reduce your Weekly transaction limit
                    </span>
                  </div>
                </div>
                <div className={style.flexout}>
                  ...
                  <div className={style.transaction}>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.weekly_limit_sending}1.2%
                    </p>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.weekly_limit_receiving}1.2%
                    </p>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.weekly_limit}1.2% per week
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className={style.limits}>
                <div className={style.timer}>
                  ...
                  <div>
                    ...
                    <span>
                      Increase or reduce your monthly transaction limit
                    </span>
                  </div>
                </div>
                <div className={style.flexout}>
                  ...
                  <div className={style.transaction}>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.monthly_limit_sending}1.2%{" "}
                    </p>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.monthly_limit_receiving}1.2%
                    </p>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.monthly_limit}1.2% per Month
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className={style.limits}>
                <div className={style.timer}>
                  ...
                  <div>
                    ...
                    <span>
                      Increase or reduce your yearly transaction limit
                    </span>
                  </div>
                </div>
                <div className={style.flexout}>
                  ...
                  <div className={style.transaction}>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.yearly_limit_sending}1.2%{" "}
                    </p>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.yearly_limit_receiving}1.2%{" "}
                    </p>
                    <p>
                      {data?.data?.currencies?.symbol}{" "}
                      {data?.data?.transactionCap?.yearly_limit}1.2% per Year
                    </p>
                  </div>
                </div>
                <button
